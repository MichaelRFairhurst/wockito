...
LIBRARYFILES := $(filter-out MockTracker CallValidator TimesCalledValidator ArgumentWatcher When,$(wildcard lib/obj/*.o))
LIBRARYTABLES := $(filter-out MockTracker CallValidator TimesCalledValidator ArgumentWatcher When,$(wildcard lib/table/*.table))
TESTLIBRARYFILES :=
